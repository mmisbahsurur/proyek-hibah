...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Edit Data Kelurahan</h6><br>
              ...
              @endif
                ...
                <div>
                    <form action="{{ route('lokkelurahan.update', $desa->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-6 mb-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select-modal form-select" name="district_id" data-width="100%" id="kotaxDropdown" >
                                        <option value="">-- Pilih Lokasi --</option>
                                        @foreach ($kec as $kecId => $name)
                                        <option value="{{ $kecId }}" @selected(old('district_id') == $kecId || $desa->district_id == $kecId)>
                                          {{ $name}}
                                        </option>
                                      @endforeach
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input  class="form-control" name="id" id="id" type="text" placeholder="Masukkan Kode Kelurahan" required value="{{ $desa->id }}">
                                    @error('id')
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input  class="form-control" name="name" id="name" type="text" placeholder="Masukkan Nama Kelurahan" required value="{{ $desa->name }}">
                                    @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="text-xs-right">
                            ...
                            <a href="{{ route('kelurahan.index') }}" class="btn btn-danger">Cancel</a>
                          </div>
                        </form>
                </div>
            </div>
