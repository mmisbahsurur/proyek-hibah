    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                data-bs-toggle="modal" data-bs-target="#tambah"data-bs-whatever="@mdo"><i class="fa fa-plus"></i>  Tambah Kecamatan
              </button><br><br>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title h4" id="modelHeading">Tambah Kecamatan</h5>
                                ...
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select-modal form-select" name="regency_id" data-width="100%" id="regency_id" >
                                                <option value="">-- Pilih Lokasi --</option>
                                                @foreach ($kab as $keylok => $lok)
                                                    <option value="{{$lok->id}}" >{{ $lok->id }} - {{$lok->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-6 mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input  class="form-control" name="id" id="id" type="text" placeholder="Masukkan Kode Kecamatan" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input  class="form-control" name="name" id="name" type="text" placeholder="Masukkan Nama Kecamatan" required>
                                        </div>
                                    </div>
                                </div>
