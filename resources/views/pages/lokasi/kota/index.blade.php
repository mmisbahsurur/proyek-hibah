...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Data Kota</h6>

                <button  type="button" class="btn btn-success btn-icon-text btn-xs"
                data-bs-toggle="modal" data-bs-target="#tambah"data-bs-whatever="@mdo"><i class="fa fa-plus"></i>  Tambah Kota
              </button><br><br>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title h4" id="modelHeading">Tambah Kota</h5>
                                ...
                                <div class="row">
                                    <div class="col-6 mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input  class="form-control" name="id" id="id" type="text" placeholder="Masukkan Id Kota" required>
                                        </div>
                                    </div>
                                    <div class="col-6 mb-3">
                                        <div class="mb-3">
                                            <label  class="form-label">Nama Kota</label>
                                            <input  class="form-control" name="name" id="name" type="text" placeholder="Masukkan Nama Kota" required>
                                        </div>
                                    </div>
                                </div>
