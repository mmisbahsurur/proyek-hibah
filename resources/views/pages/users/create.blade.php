                        ...
                        {!! Form::open(array('route' => 'users.store','method'=>'POST')) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="role" id="" class=" select2 form-control custom-select" style="width: 100%; height: 36px;">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="type" class=" form-control custom-select" style="width: 100%; height: 36px;" required>
