                                ...
                                <div class="alert alert-danger alert-dismissible fade show print-error-msg" role="alert" style="display:none">
                                  ...
                                  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"></button>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        {{-- <input id="type" class="form-control " name="type" type="text" placeholder="Masukkan Nama" required> --}}
                                        <select class="form-select " name="type" id="type" data-width="100%" >
                                            <option >Select Role</option>
                                            <option value="admin">Admin</option>
                                            <option value="bidang">Bidang/Balai</option>
